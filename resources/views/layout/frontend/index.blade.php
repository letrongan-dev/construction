    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-cap mb-30">
                    <div class="service-img">
                        <img src="{{asset('public/frontend/assets/img/service/servicess1.png')}}" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-cap mb-30">
                    <div class="service-img">
                        <img src="{{asset('public/frontend/assets/img/service/servicess2.png')}}" alt="">
                    </div>
                    <div class="service-cap">
                        <h4><a href="services_details.html">Engineering techniques & implementation</a></h4>
                        <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="single-service-cap mb-30">
                    <div class="service-img">
                        <img src="{{asset('public/frontend/assets/img/service/servicess3.png')}}" alt="">
                    </div>
                    <div class="service-cap">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{asset('public/frontend/assets/img/team/team1.png')}}" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{asset('public/frontend/assets/img/team/team2.png')}}" alt="">
                    </div>
                    <div class="team-caption">
                        <span>UX Designer</span>
                        <h3>Ethan Welch</h3>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                <div class="single-team mb-30">
                    <div class="team-img">
                        <img src="{{asset('public/frontend/assets/img/team/team3.png')}}" alt="">
                    </div>
                    <div class="team-caption">
                        <span>UX Designer</span>
                        <h3>Ethan Welch</h3>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6">
                ...
                <div class="single-news mb-30">
                    <div class="news-img">
                        <img src="{{asset('public/frontend/assets/img/david/david_1.png')}}" alt="">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                ...
                <div class="single-news mb-30">
                    <div class="news-img">
                        <img src="{{asset('public/frontend/assets/img/david/david_2.png')}}" alt="">
                        <div class="news-date text-center">
                            <span>24</span>
                            <p>Now</p>
                        </div>
