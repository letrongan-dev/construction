...
<div class="content">
  ...
  <div class="card-body">
    ...
    @endforeach
    <form action="{{URL::to('/admin/service/update/'.$service->id_service)}}" method="post" enctype="multipart/form-data">
         <input type="hidden" name="_token" value="{{csrf_token()}}" >
    	<div class="row mt-4">
	      <div class="col-lg-6">
	        <fieldset class="form-group">
	          <label class="text-red">Tiêu đề *</label>
	          <input class="form-control" id="name" name="title" type="text" readonly value="{{$service->title}}">
	        </fieldset>
	      </div>
	      <div class="col-lg-6">
	        <fieldset class="form-group">
	          ...
	          <textarea class="form-control" name="description" type="text">{{$service->description}}</textarea>
	        </fieldset>
	      </div>
	  	</div>
	  	<div class="row">
	  	<div class="col-lg-6">
	        <fieldset class="form-group">
	          <label>Slug</label>
	          <input class="form-control" name="slug" id="slug" type="text" readonly value="{{$service->slug}}">
	        </fieldset>
	      </div>
	      <div class="col-lg-6">
	        <fieldset class="form-group">
              ...
              <div class="row">
                    <img src='{{asset("public/frontend/img/service/$service->banner")}}' class="col-lg-4" height="70" width="70">
	     ...
	     <div class="col-lg-12">
	        <fieldset class="form-group">
	          ...
	          <textarea class="form-control" name="content" type="textarea" id="descTextarea">{!! $service->content !!}</textarea>
	        </fieldset>
	      </div>
	    </div>
